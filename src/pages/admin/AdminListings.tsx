  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (active) setError(e.message ?? 'Erro ao carregar imóveis')
      } finally {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-semibold">Admin · Imóveis</h1>
      </div>
...
function SuccessBanner() {
  ...
  useEffect(() => {
    ...
    if (q.get('updated') === '1') setVisible(true)
  }, [location.search])
  ...
  return (
    <div className="mb-4 rounded-md border border-emerald-300 bg-emerald-50 text-emerald-800 px-4 py-3 text-sm flex items-center justify-between">
      <span>Imóvel atualizado com sucesso.</span>
