    ...
    <article className="group bg-white rounded-2xl shadow overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="relative aspect-[4/3] bg-gray-200">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          ...
          {p.is_for_rent && (
            <span className="text-[11px] px-2 py-1 rounded-full bg-secondary text-white capitalize">Aluguel</span>
          )}
        </div>
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-2">
          ...
          <button aria-label="Favoritar" className="text-gray-400 hover:text-secondary">♡</button>
        </div>
        ...
        <div className="mt-3 flex items-center gap-3">
          <Link to={link} className="bg-secondary text-white rounded-md px-4 py-2 text-sm hover:opacity-90">Mais detalhes</Link>
